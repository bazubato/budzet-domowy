...
export default function BudzetDomowy() {
  ...
  function dodajTransakcje(e) {
    ...
    const wpis = {
      ...
      typ,
      kwota: kwotaLiczba,
      kategoria: typ === "wydatek" ? nazwaKategorii : (opis.trim() || "Wpływ"),
      opis: opis.trim(),
      data,
    };
    const nowe = [wpis, ...transakcje];
    setTransakcje(nowe);
  ...
  return (
    <div className="bd-app">
      ...
      {widok === "zapisy" && (
      <>
      <form className="bd-formularz" onSubmit={dodajTransakcje}>
...
.bd-usun-mikro { color: var(--ink-muted); padding: 4px; opacity: 0.7; flex-shrink: 0; }
.bd-usun-mikro:hover { opacity: 1; color: var(--czerwony); }
